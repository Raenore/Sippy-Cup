...
L = {
	...
	OPTIONS_GENERAL_POPUPS_PRE_EXPIRATION_LEAD_TIMER = "Reminder Lead Time", -- (NEW)
	OPTIONS_GENERAL_POPUPS_PRE_EXPIRATION_LEAD_TIMER_TEXT = "Set the desired time, in minutes, before expiration when a reminder popup should be shown (default: 1 minute).|n|n|cnWARNING_FONT_COLOR:If an option does not support the chosen time, it will default to 1 minute, or 15 seconds if 1 minute is not supported.|r", -- (NEW)
