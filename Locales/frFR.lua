...
L = {
	...
	OPTIONS_GENERAL_POPUPS_PRE_EXPIRATION_LEAD_TIMER = "Anticipation du Rappel",
	OPTIONS_GENERAL_POPUPS_PRE_EXPIRATION_LEAD_TIMER_TEXT = "Définit le délai, en minutes, avant Expiration pour l'affichage d'une Notification de Rappel (par défaut: 1 minute).|n|n|cnWARNING_FONT_COLOR:Si une option ne prend pas en charge le délai choisi, la valeur sera par défaut de 1 minute, ou 15 secondes si 1 minute n'est pas disponible.|r",
