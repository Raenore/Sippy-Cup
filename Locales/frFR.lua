...
L.POPUP_LACKING_TEXT_AMOUNT = "insuffisant dans votre inventaire.|n(%d manquant)";
L.POPUP_LACKING_TEXT_NEXT_REFRESH = "insuffisant (%d / %d) pour le prochain rafraîchissement.";
