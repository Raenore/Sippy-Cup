...
L = {
	...
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_DESC = "Configures the specific conditions under which Sippy Cup displays reminder popups.",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_DISABLED = "Disabled",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_DISABLED_DESC = "Disables all reminder popups entirely.",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_IC = "In Character Only",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_IC_DESC = "Popups only trigger when your status is |cnGREEN_FONT_COLOR:In Character|r.|n|n|cnWARNING_FONT_COLOR:Note: Requires an RP addon (TRP/MRP/XRP). If none are found, this defaults to 'Always'.|r",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_SMART = "Smart (Active Only)",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_SMART_DESC = "Only triggers reminder popups for options that are currently active.|n|nThis limits alerts to relevant notifications, preventing unnecessary noise.",
