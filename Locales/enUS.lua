...
L.OPTIONS_ENABLE_NON_AURA_TEXT = "|n|n|cnWARNING_FONT_COLOR:Note that this consumable is harder to track, resulting in possible irregularities from time to time.|r";
