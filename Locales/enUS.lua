...
L = {
	...
	STARTUPMSG_REMINDER_BEHAVIOR_DISABLED = "Reminder behavior set to |cnGREEN_FONT_COLOR:Disabled|r, reminder popups will not be shown!",
	...
	OPTIONS_GENERAL_MINIMAP_NAME = "Minimap Options",
	OPTIONS_GENERAL_MINIMAP_DESC = "Toggles the display of Sippy Cup's minimap options.",
	...
	OPTIONS_GENERAL_POPUPS_HEADER = "Popup Behavior",
	...
	OPTIONS_GENERAL_POPUPS_PRE_EXPIRATION_LEAD_TIMER = "Pre-Expiration Lead Time",
	OPTIONS_GENERAL_POPUPS_PRE_EXPIRATION_LEAD_TIMER_TEXT = "Set the desired time, in minutes, before the pre-expiration reminder popup should be shown (default: 1 minute).|n|n|cnWARNING_FONT_COLOR:If an option does not support the chosen time, it will default to 1 minute, or 15 seconds if 1 minute is not supported.|r",
	...
	OPTIONS_GENERAL_REMINDER_BEHAVIOR = "Reminder Behavior",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_DESC = "Configures the specific conditions under which Sippy Cup displays reminder popups.|n|nAn option is |cnHIGHLIGHT_FONT_COLOR:enabled|r once you've toggled it on in one of the option tabs (Appearance, Effect, Handheld, etc.), and |cnGREEN_FONT_COLOR:active|r while its aura/buff is currently present on your character.",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_DISABLED = "Disabled",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_DISABLED_DESC = "Disables all reminder popups entirely; none will ever show.",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_IC = "In Character Only",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_IC_DESC = "Triggers reminder popups for every |cnHIGHLIGHT_FONT_COLOR:enabled|r option while your status is |cnGREEN_FONT_COLOR:In Character|r, regardless of whether it's currently active.|n|n|cnWARNING_FONT_COLOR:Note: Requires an RP addon (TRP/MRP/XRP). If none are found, this defaults to 'Always'.|r",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_SMART = "Smart (Active Only)",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_SMART_DESC = "Only triggers reminder popups for |cnHIGHLIGHT_FONT_COLOR:enabled|r options that are currently |cnGREEN_FONT_COLOR:active|r.|n|nThis limits alerts to relevant notifications, preventing unnecessary noise.",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_ALWAYS = "Always (All Options)",
	OPTIONS_GENERAL_REMINDER_BEHAVIOR_ALWAYS_DESC = "Triggers reminder popups for every |cnHIGHLIGHT_FONT_COLOR:enabled|r option, regardless of whether it's currently |cnGREEN_FONT_COLOR:active|r.|n|n|cnWARNING_FONT_COLOR:Note: This can be very frequent, as it evaluates every enabled option.|r",
	...
	OPTIONS_GENERAL_POPUPS_POSITION_TOP = "Top (Default)",
	OPTIONS_GENERAL_POPUPS_POSITION_CENTER = "Center",
	OPTIONS_GENERAL_POPUPS_POSITION_BOTTOM = "Bottom",
	OPTIONS_GENERAL_POPUPS_SHOW_AURA_ICON = "Show Aura Icon",
	OPTIONS_GENERAL_POPUPS_SHOW_AURA_ICON_DESC = "Toggles showing the aura's icon on the right side of the popup, separate from the consumable/toy's own icon on the left.|n|nA consumable/toy's link doesn't always represent the aura it actually grants, so this can help confirm the effect that's really being tracked.|n|n|cnWARNING_FONT_COLOR:Disabled by default.|r",
